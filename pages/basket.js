  ...
  return (
    <div className=" p-14 flex justify-between">
      ...
      <div className=" w-[17%] h-fit shadow-[rgba(149,157,165,0.2)_0px_8px_24px]">
        ...
        <button className="bg-[#b37272] ease-in duration-100 h-[80px] rounded-b-[3px] w-[100%] text-xl text-white hover:shadow-[rgba(0,0,0,0.2)_0px_18px_50px_-10px] hover:brightness-110">
          Complete Shopping
        </button>
      </div>
    </div>
